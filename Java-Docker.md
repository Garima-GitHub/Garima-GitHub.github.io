...
## Similarly, to tell the JVM to be aware of Docker memory limits in the absence of setting a maximum Java heap via -Xmx, there were two JVM command line options required, 
